...
class WebSocketServer:
    def __init__(self, host: str = "0.0.0.0", port: int = 8765):
        ...
        self.timer_control_handler = None
    ...
    def set_timer_control_handler(self, handler):
        self.timer_control_handler = handler
    ...
    async def handler(self, websocket):
        ...
        try:
            async for raw in websocket:
                ...
                elif msg_type == "timer_control" and self.timer_control_handler:
                    await self.timer_control_handler(msg)
